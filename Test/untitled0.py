...
# -*- coding: utf-8 -*-
"""
Created on Mon May 20 08:48:55 2019
...
for i in range(1, filelimit + 1): 
    ...
    image = image.crop((490, 528, 3915, 4843))
    #plt.imshow(image)
...
def IndexScrapping(pdf_path):
    ...
    indexContent = pytesseract.image_to_string(imag)
    
    """Removing next line"""
    WithoutNextLine = re.sub(r'\n','',indexContent)
    Withoutdot = WithoutNextLine.replace(".", "")
    """Custom text removal"""
    RepairText = re.sub("Contents |   12", "" , Withoutdot)
